...
export const DEFAULT_CONTENT: SiteContent = {
  ...
  references: {
    ...
    subtitle: "Farklı sektörlerden markalar için ürettiğimiz seçki çalışmalar.",
    projects: [
      { title: "Nova Commerce", tag: "E-Ticaret", gradient: "from-violet-600/40 to-fuchsia-600/30" },
      { title: "Atlas Kurumsal", tag: "Web Platformu", gradient: "from-blue-600/40 to-cyan-600/30" },
      { title: "Lumen AI", tag: "Yapay Zeka", gradient: "from-indigo-600/40 to-violet-600/30" },
      { title: "Pulse Mobile", tag: "Mobil Uygulama", gradient: "from-sky-600/40 to-blue-600/30" },
    ],
  },
  testimonials: {
    eyebrow: "Referanslar",
